...
(function () {
    ...
    const targetNames = [
        'ADA HERRERA', 'ADA SUAREZ', 'ALFONSO ANASTACIA', 'AMPARO DIAZ PENA', 'ANDREA BORGES VILLEGAS',
        ...
        'CLARA CEA', 'CLARA URIBE', 'CLAUDIO OVES', 'CONSUELO CORTES', 'CONSUELO ROQUE', 'DANIA R. FERNANDEZ', 'DIEGO L. RODRIGUEZ',
        ...
        'MARIA RODRIGUEZ MONT', 'MAYRA LOPEZ', 'MERCEDES D. BOFILL', 'MERCEDES GENTIL', 'MIRELLA BARREIRO', 'MIRIAN SANTOS', 'MIRIAM GUERRA SERRANO',
        ...
        'YARISEL PEREZ', 'YOLANDA SUAREZ', 'YBONNE YGLESIAS', 'ZENAIDA MOJENA', 'ZENAIDA PICALLO SERRA'
    ];
